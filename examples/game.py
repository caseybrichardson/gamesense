#!/usr/bin/env python
"""
Taken from a great example of pygame:
https://github.com/ternus/pygame-examples

All credit to Ternus for this script. Very few changes were needed
to make this example work with GameSense.
"""
...
def register_gamesense():
    gs = gamesense.GameSense("SNAKE", "Snake")

    register_resp = gs.register_game(icon_color_id=gamesense.GS_ICON_GREEN)
    if not register_resp.success:
        print(register_resp.data)

    event_resp = gs.register_event("APPLE")
